    ...
    form.parse(req, (error, fields, files) => {
        ...
        if (files.photo) {
            if (files.photo.size > 1000000) {
                return res.status(400).json({
                    error: 'Image should be less tha 1mb in size'
                })
            }
...
/**
 * It will return the products based on the req product category
...
exports.listSearch = (req, res) => {
    ...
    //assign the category value to the query.category
